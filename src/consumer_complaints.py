...
def write_temp_csv():
    with open(os.path.realpath('../MMONTINE/input/complaints.csv'), encoding='utf8') as complaints:
...
def write_output_csv():
    with open(os.path.realpath('../MMONTINE/output/report.csv'), 'w+') as output_csv:
